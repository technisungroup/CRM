                                        ...
                                        @foreach($data as $key => $dt)
                                            <tr class="tr-{{$dt->id}}">
                                                ...
                                                <td>
                                                    ...
                                                    {{-- <a href="{{ route('companies.edit',$dt->id) }}" id="btn-edit-{{$dt->id}}" class="btn btn-primary btn-sm">Edit</a>
                                                     <form action="{{route('companies.destroy',$dt->id)}}" id="companies_delete_{{$dt->id}}" method="post" style="float: left">
                                                         @csrf
                                                         @method('delete')
                                                    ...
                                                    <a href="{{ route('companies.edit',$dt->id) }}" id="btn-edit-{{$dt->id}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
                                                        <i class="fa fa-pencil" aria-hidden="true"></i>
                                                    </a>

                                                    <form action="{{route('companies.destroy',$dt->id)}}" id="btn-{{$dt->id}}" method="post" class="d-inline-block">
                                                        @csrf
                                                        @method('delete')
