                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                ...
                                <a href="{{ route('locations.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
                                    Add New Location
                                </a>
                                            ...
                                            @foreach($data as $key => $dt)
                                                <tr class="tr-{{$dt->id}}">
                                                    ...
                                                    <td>
                                                       ...
                                                       {{-- <a href="{{ route('locations.edit',$dt->id) }}" id="btn-edit-{{$dt->id}}" class="btn btn-primary btn-sm">Edit</a>
                                                        <form action="{{route('locations.destroy',$dt->id)}}" id="locations_delete_{{$dt->id}}" method="post" style="float: left">
                                                            @csrf
                                                            @method('delete')
                                                            <button type="button" onclick="deleteModule(this,'{{ $dt->id }}')" id="btn-{{$dt->id}}" class="btn btn-danger btn-sm">
                                                                <i class='fa fa-trash'></i> Delete
                                                            </button>
                                                        </form>--}}

                                                        <a href="{{ route('locations.edit',$dt->id) }}" id="btn-edit-{{$dt->id}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit">
                                                            <i class="fa fa-pencil" aria-hidden="true"></i>
                                                        </a>

                                                        <form action="{{route('locations.destroy',$dt->id)}}" id="locations_delete_{{$dt->id}}" method="post" class="d-inline-block">
                                                            @csrf
                                                            @method('delete')
