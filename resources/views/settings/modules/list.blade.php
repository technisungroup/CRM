        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <div id="kt_table_1_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="" role="grid" aria-describedby="kt_table_1_info" style="width: 1661px;">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Title</th>
                                    ...
                                    @foreach($data as $key => $dt)
                                        <tr class="tr-{{$dt->id}}">
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('modules.destroy',$dt->id)}}" id="modules_delete_{{$dt->id}}" method="post" class="d-inline-block">
                                                    @csrf
                                                    @method('delete')
